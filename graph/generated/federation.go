...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		case "Foo":
			...
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Foo": %w`, err)
			}
			switch resolverName {
			...
			case "findFooByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findFooByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindFooByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Foo": %w`, err)
				}
...
func entityResolverNameForFoo(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
